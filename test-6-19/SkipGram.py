...
def main():
    ...
    #####
    # 大数据集,未完成，预计需要负采样等提高训练速度
    # dataset = EmbeddingDataset(".\\python\\reduce_zhiwiki.txt")
    # model = EmbeddingModel(dataset)
    # model.cuda()
    # print(model.is_cuda)
    # model.train()
    # torch.save(model, ".\\python\\2023-6-14\\SkipGram2.pth")
    # kk = torch.load(".\\python\\2023-6-14\\SkipGram2.pth")
    # Embedding_Visualization(
    #     kk,
    #     ".\\python\\2023-6-14\\output_SkipGram2.png",
    #     ".\\python\\2023-6-14\\output_SkipGram2.html",
    # )
    # word2vec_pred(kk, ".\\python\\2023-6-14\\word2vec_pred2.html")
    #####
    # # 中数据集
    # dataset = EmbeddingDataset(".\\python\\2023-6-14\\test-6-20\\test-6-20.txt")
    # model = EmbeddingModel(dataset)
    # model.cuda()
    # print(len(model.wordlist))
    # model.train()
    # torch.save(
    #     model,
    #     ".\\python\\2023-6-14\\test-6-20\\test-6-20.pth",
    # )
    # Embedding_Visualization(
    #     model,
    #     ".\\python\\2023-6-14\\test-6-20\\test-6-20_tSNE.png",
    #     ".\\python\\2023-6-14\\test-6-20\\test-6-20_embedding.html",
    # )
    # word2vec_pred(
    #     model,
    #     ".\\python\\2023-6-14\\test-6-20\\test-6-20_pred.html",
    # )
    #####
    # 小数据集"test-6-19.txt",已检查无nan
    # dataset = EmbeddingDataset(".\\python\\2023-6-14\\test-6-19\\test-6-19.txt")
    # model = EmbeddingModel(dataset)
    # model.cuda()
    # print(len(model.wordlist))
    # model.train()
    # torch.save(
    #     model,
    #     ".\\python\\2023-6-14\\test-6-19\\test-6-19.pth",
    # )
    # Embedding_Visualization(
    #     model,
    #     ".\\python\\2023-6-14\\test-6-19\\test-6-19_tSNE.png",
    #     ".\\python\\2023-6-14\\test-6-19\\test-6-19_embedding.html",
    # )
    # word2vec_pred(
    #     model,
    #     ".\\python\\2023-6-14\\test-6-19\\test-6-19_pred.html",
    # )
    #####
    model = torch.load(".\\python\\2023-6-14\\test-6-20\\test-6-20.pth")
    print(torch.isnan(model.w1).int().sum())
    print(torch.isnan(model.w2).int().sum())
